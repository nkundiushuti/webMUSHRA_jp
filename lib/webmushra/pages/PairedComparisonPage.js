...
function PairedComparisonPage(_pageManager, _pageTemplateRenderer, _pageConfig, _session, _language, _dataSender, _audioContext, _bufferSize, _audioFileLoader, _errorHandler, _reference, _condition) {
  ...
  Object.getPrototypeOf(PairedComparisonPage.prototype).addAudioFile.call(this, this.reference.getFilepath(), this.reference);
  Object.getPrototypeOf(PairedComparisonPage.prototype).addAudioFile.call(this, this.condition.getFilepath(), this.condition);
