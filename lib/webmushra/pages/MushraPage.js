...
function MushraPage(_pageManager, _pageTemplateRenderer, _pageConfig, _session, _language, _dataSender, _audioContext, _bufferSize, _audioFileLoader, _errorHandler, _mushraValidator) {
  ...
  Object.getPrototypeOf(MushraPage.prototype).addAudioFile.call(this, this.reference.getFilepath(), this.reference);
  for (var i = 0; i < this.conditions.length; ++i) {
    Object.getPrototypeOf(MushraPage.prototype).addAudioFile.call(this, this.conditions[i].getFilepath(), this.conditions[i]);
  }
